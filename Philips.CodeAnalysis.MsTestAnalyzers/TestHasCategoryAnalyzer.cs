...
namespace Philips.CodeAnalysis.MsTestAnalyzers
{
	...
	public class TestHasCategoryAnalyzer : TestMethodDiagnosticAnalyzer
	{
		...
		private static readonly DiagnosticDescriptor Rule = new(DiagnosticId.TestHasCategoryAttribute.ToId(), Title, MessageFormat, Category, DiagnosticSeverity.Error, isEnabledByDefault: true, description: Description, helpLinkUri: DiagnosticId.TestHasCategoryAttribute.ToHelpLinkUrl());
