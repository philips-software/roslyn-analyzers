...
namespace Philips.CodeAnalysis.MsTestAnalyzers
{
	...
	public class TestClassPublicMethodShouldBeTestMethodAnalyzer : DiagnosticAnalyzerBase
	{
		...
		private static readonly DiagnosticDescriptor Rule = new(DiagnosticId.TestClassPublicMethodShouldBeTestMethod.ToId(), Title, MessageFormat, Category, DiagnosticSeverity.Error, isEnabledByDefault: true, description: Description, helpLinkUri: DiagnosticId.TestClassPublicMethodShouldBeTestMethod.ToHelpLinkUrl());
