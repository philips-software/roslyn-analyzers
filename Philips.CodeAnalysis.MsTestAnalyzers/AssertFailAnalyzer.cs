...
namespace Philips.CodeAnalysis.MsTestAnalyzers
{
	...
	public class AssertFailAnalyzer : DiagnosticAnalyzerBase
	{
		...
		private static readonly DiagnosticDescriptor Rule = new(DiagnosticId.AssertFail.ToId(), Title, MessageFormat, Category, DiagnosticSeverity.Error, isEnabledByDefault: true, description: Description, helpLinkUri: DiagnosticId.AssertFail.ToHelpLinkUrl());
