...
namespace Philips.CodeAnalysis.MsTestAnalyzers
{
	...
	public class TestShouldUseDisplayNameAnalyzer : TestMethodDiagnosticAnalyzer
	{
		...
		private static readonly DiagnosticDescriptor Rule = new(DiagnosticId.UseDisplayNameOrDescription.ToId(), Title, MessageFormat, Category, DiagnosticSeverity.Info, isEnabledByDefault: true, description: Description);
