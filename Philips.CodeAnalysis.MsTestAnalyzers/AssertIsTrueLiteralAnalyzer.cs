...
namespace Philips.CodeAnalysis.MsTestAnalyzers
{
	...
	public class AssertIsTrueLiteralAnalyzer : AssertIsTrueFalseDiagnosticAnalyzer
	{
		...
		private static readonly DiagnosticDescriptor IsTrueRule = new DiagnosticDescriptor(Helper.ToDiagnosticId(DiagnosticIds.AssertIsTrueLiteral), IsTrueTitle, IsTrueMessageFormat, Category, DiagnosticSeverity.Error, isEnabledByDefault: false, description: IsTrueDescription);
