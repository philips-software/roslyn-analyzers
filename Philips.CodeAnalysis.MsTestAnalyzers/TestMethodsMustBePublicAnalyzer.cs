...
namespace Philips.CodeAnalysis.MsTestAnalyzers
{
	...
	public class TestMethodsMustBePublicAnalyzer : TestMethodDiagnosticAnalyzer
	{
		...
		private static readonly DiagnosticDescriptor Rule = new(DiagnosticId.TestMethodsMustBePublic.ToId(),
												Title, MessageFormat, Category, DiagnosticSeverity.Error, isEnabledByDefault: true, description: Description, helpLinkUri: DiagnosticId.TestMethodsMustBePublic.ToHelpLinkUrl());
		...
		{
			return new TestMethodsMustBePublic(definitions, Helper);
		}

		private sealed class TestMethodsMustBePublic : TestMethodImplementation
		{
			public TestMethodsMustBePublic(MsTestAttributeDefinitions definitions, Helper helper) : base(definitions, helper)
			{ }
