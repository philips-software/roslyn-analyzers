...
namespace Philips.CodeAnalysis.MsTestAnalyzers
{
	...
	public class TestContextAnalyzer : DiagnosticAnalyzerBase
	{
		...
		private static readonly DiagnosticDescriptor Rule = new(DiagnosticId.TestContext.ToId(), Title, MessageFormat, Category, DiagnosticSeverity.Error, isEnabledByDefault: true, description: Description, helpLinkUri: DiagnosticId.TestContext.ToHelpLinkUrl());
