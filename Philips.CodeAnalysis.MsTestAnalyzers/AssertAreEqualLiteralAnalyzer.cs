...
namespace Philips.CodeAnalysis.MsTestAnalyzers
{
	...
	public class AssertAreEqualLiteralAnalyzer : AssertMethodCallDiagnosticAnalyzer
	{
		...
		private static readonly DiagnosticDescriptor Rule = new(DiagnosticId.AssertAreEqualLiteral.ToId(), Title, MessageFormat, Category, DiagnosticSeverity.Error, isEnabledByDefault: true, description: Description, helpLinkUri: DiagnosticId.AssertAreEqualLiteral.ToHelpLinkUrl());
