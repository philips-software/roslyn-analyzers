...
namespace Philips.CodeAnalysis.MaintainabilityAnalyzers
{
	...
	public class ServiceContractAreAnnotatedWithOperationContractAttributeAnalyzer : DiagnosticAnalyzer
	{
		...
		private static DiagnosticDescriptor Rule = new DiagnosticDescriptor(Helper.ToDiagnosticId(DiagnosticIds.ServiceContractsMustHaveOperationContractAttributes), Title, MessageFormat, Category, DiagnosticSeverity.Error, isEnabledByDefault: false, description: Description);
