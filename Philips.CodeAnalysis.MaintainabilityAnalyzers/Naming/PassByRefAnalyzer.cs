...
namespace Philips.CodeAnalysis.MaintainabilityAnalyzers.Maintainability
{
	...
	public class PassByRefAnalyzer : DiagnosticAnalyzer
	{
		...
		public DiagnosticDescriptor Rule = new(Helper.ToDiagnosticId(DiagnosticIds.AvoidPassByReference), Title, MessageFormat, Category, DiagnosticSeverity.Error, isEnabledByDefault: true, description: Description);
