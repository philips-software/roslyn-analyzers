...
| PH2106  | Avoid multiple conditions on same line       | In case that the condition of an "if" or "?" statement covers more then one line, its line endings should be on the logical operators (&& and ||). |
