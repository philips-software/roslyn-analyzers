...
namespace Philips.CodeAnalysis.MaintainabilityAnalyzers.Maintainability
{
	...
	public class AvoidTaskResultAnalyzer : DiagnosticAnalyzerBase
	{
		...
		private static readonly DiagnosticDescriptor Rule = new(DiagnosticId.AvoidTaskResult.ToId(), Title, MessageFormat, Category, DiagnosticSeverity.Error, isEnabledByDefault: true, description: Description, helpLinkUri: DiagnosticId.AvoidTaskResult.ToHelpLinkUrl());
