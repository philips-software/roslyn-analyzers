...
namespace Philips.CodeAnalysis.MaintainabilityAnalyzers.Maintainability
{
	...
	public class AvoidPublicMemberVariableAnalyzer : DiagnosticAnalyzer
	{
		...
		public DiagnosticDescriptor Rule { get; } = new(Helper.ToDiagnosticId(DiagnosticIds.AvoidPublicMemberVariables), Title, MessageFormat, Category, DiagnosticSeverity.Error, isEnabledByDefault: false, description: Description);
