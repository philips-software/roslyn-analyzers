...
namespace Philips.CodeAnalysis.MaintainabilityAnalyzers.Readability
{
	...
	public class PreferTupleFieldNamesAnalyzer : DiagnosticAnalyzer
	{
		...
		public static DiagnosticDescriptor Rule = new DiagnosticDescriptor(Helper.ToDiagnosticId(DiagnosticIds.PreferUsingNamedTupleField), Title, MessageFormat, Category, DiagnosticSeverity.Error, isEnabledByDefault: true, description: Description);
