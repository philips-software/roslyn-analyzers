...
namespace Philips.CodeAnalysis.MaintainabilityAnalyzers.Readability
{
	...
	public class PreferTupleFieldNamesAnalyzer : DiagnosticAnalyzerBase
	{
		...
		public static readonly DiagnosticDescriptor Rule = new(DiagnosticId.PreferUsingNamedTupleField.ToId(), Title, MessageFormat, Category, DiagnosticSeverity.Error, isEnabledByDefault: true, description: Description, helpLinkUri: DiagnosticId.PreferUsingNamedTupleField.ToHelpLinkUrl());
