...
namespace Philips.CodeAnalysis.MaintainabilityAnalyzers.Documentation
{
	...
	public class XmlDocumentationShouldAddValueAnalyzer : DiagnosticAnalyzerBase
	{
		...
		private static readonly DiagnosticDescriptor ValueRule = new(DiagnosticId.XmlDocumentationShouldAddValue.ToId(), ValueTitle, ValueMessageFormat, Category, DiagnosticSeverity.Error, isEnabledByDefault: true, description: ValueDescription, helpLinkUri: DiagnosticId.XmlDocumentationShouldAddValue.ToHelpLinkUrl());
		private static readonly DiagnosticDescriptor EmptyRule = new(DiagnosticId.EmptyXmlComments.ToId(), EmptyTitle, EmptyMessageFormat, Category, DiagnosticSeverity.Error, isEnabledByDefault: true, description: EmptyDescription, helpLinkUri: DiagnosticId.EmptyXmlComments.ToHelpLinkUrl());
