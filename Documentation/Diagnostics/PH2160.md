...
```ini
dotnet_code_quality.PH2160.preferred_disposable_mock_type = MyNamespace.DisposeCallBaseMock
```
...
```csharp
private readonly MyNamespace.DisposeCallBaseMock<MyDisposable> _mock = new MyNamespace.DisposeCallBaseMock<MyDisposable>();
```
