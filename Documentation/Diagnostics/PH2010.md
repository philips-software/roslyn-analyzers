...
Note: This rule addresses a very specific parentheses pattern. For more comprehensive parentheses style enforcement, consider migrating to [Microsoft's official MSTest analyzers](../MsTest.md#migration-guide) or using the generic IDE rule below.
