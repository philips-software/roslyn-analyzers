...
{
	[TestClass]
	public class LiteralHelperNullTest : DiagnosticVerifier
	{

		[DiagnosticAnalyzer(LanguageNames.CSharp)]
		private sealed class IsNullAnalyzer : DiagnosticAnalyzerBase
		{
			...
			private void Analyze(SyntaxNodeAnalysisContext context)
			{
				...
				context.ReportDiagnostic(Helper.ForLiterals.IsNull(expression)
		...
		public async Task CheckIsNull(string expression, bool expectedToBeLiteral)
		{
			// Arrange
