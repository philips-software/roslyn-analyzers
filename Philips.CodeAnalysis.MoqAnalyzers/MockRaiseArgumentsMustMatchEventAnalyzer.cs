...
namespace Philips.CodeAnalysis.MoqAnalyzers
{
	...
	public class MockRaiseArgumentsMustMatchEventAnalyzer : DiagnosticAnalyzerBase
	{
		...
		private static readonly DiagnosticDescriptor TypeMismatchRule = new(DiagnosticId.MockRaiseArgumentsMustMatchEvent.ToId(), Title, MessageFormatTypeMismatch, Category, DiagnosticSeverity.Error, isEnabledByDefault: true, description: Description, helpLinkUri: DiagnosticId.MockRaiseArgumentsMustMatchEvent.ToHelpLinkUrl());
		private static readonly DiagnosticDescriptor ArgumentCountRule = new(DiagnosticId.MockRaiseArgumentCountMismatch.ToId(), Title, MessageFormatArgumentCount, Category, DiagnosticSeverity.Error, isEnabledByDefault: true, description: Description, helpLinkUri: DiagnosticId.MockRaiseArgumentCountMismatch.ToHelpLinkUrl());
